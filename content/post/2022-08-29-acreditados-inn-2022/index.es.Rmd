...
Hace ya casi 1 año publiqué un [post](https://www.linkedin.com/posts/cjgomezs_acreditados-activity-6856380114675011584-7hnO?utm_source=share&utm_medium=member_desktop) acerca de cuántos laboratorios de ensayo hay acreditados existen en Chile el 2021. La publicación generó airadas reacciones, sin embargo, se abrió un interesante debate (esa es la idea).
...
Ahora haremos el gráfico de barras el cuall indica el número de laboratorios de 
...
Considerar que algunas razones sociales podrían tener varios laboratorios/alcances
acreditados, por lo tanto, este gráfico en realidad cuenta el número de acreditaciones.

Para conocer el número total de laboratorios de ensayos acreditados por el INN use los
siguientes comandos:
...
Para conocer el número de razones sociales/Organizaciones acreditadas use:
